...
export const TimeLineData = [
  ...
  {
    year: 2024,
    text: "Focusing on backend development using Node.js and Golang.",
  },
];

export const TelegramUrl = "https://t.me/i_came_for_memes";

export const HHUrl =
  "https://hh.ru/resume/52b28affff0d3847660039ed1f69454e635473";

export const ResumeUrl = 'https://pdfs.cakeresume.com/user_pdfs/d2d145a3-ee3e-4690-93c4-498ba238e3b5.pdf';

export const GithubUrl = "https://github.com/patau23";

export const LinkedInUrl =
  "https://www.linkedin.com/in/akezhan-amirkhanov-61a210253/";

export const MobileNumber = "- - -";

export const PersonalEmail = "akejan2302@gmail.com";
